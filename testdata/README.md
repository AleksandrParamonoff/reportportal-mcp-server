...
- `*.json` – standalone test cases (e.g., `get_launches_test.json`, `get_test_item_by_id_real.json`).
- `collections/*.json` – optional Postman collections used by the collection runner.
